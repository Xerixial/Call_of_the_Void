 ...
 */
public class ItemPedestalRenderer extends TileEntitySpecialRenderer {

    @Override
    public void renderTileEntityAt(TileEntity te, double x, double y, double z, float partialTick, int destroyStage){

        renderItem((ItemPedestalTileEntity) te, x, y, z);

    }

    public void renderItem(ItemPedestalTileEntity tile, double x, double y, double z) {
